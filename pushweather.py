...
os.environ["AMBIENT_API_KEY"] = 'c8c041469de789e55832b5b9461d91ca5d6a48b1b3eabb6aed74f7de'
os.environ["AMBIENT_APPLICATION_KEY"] = 'ab0a463b808026833a7f8a1913dc12b9cb774d0b8342393e3bbf45b3'
...
latitude = 
longitude = 
devicename = 'WS2902  TX' #This identifies your equipment/software. You can put anything you want. I use 'WS2902A', which is the model of weather station I have
...
if longitude < 0:
 ...
 #over ride due to location conversion issues. 
latitude='2834.45N'
longitude='093=00.92W'
...
s.send('user ' + callsign + ' pass 18341 vers Python\n')
s.send(packet+'\n')
s.shutdown(0)
